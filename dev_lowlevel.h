...
static const struct usb_device_descriptor device_descriptor = {
    ...
    .idVendor = 0x2EBE,     // Your vendor id
    .idProduct = 0x504B,    // Your product ID
...
static const unsigned char vendor_string[] = {
    2 + 2 * 17, // 36
    0x03,       // STRING descriptor type
    'K', 0, 'r', 0, 'z', 0, 'y', 0, 's', 0, 'z', 0, 't', 0, 'o', 0, 'f', 0, ' ', 0, 'P', 0, 'l', 0, 'o', 0, 'n', 0, 'k', 0, 'a', 0};

// Product string: "USB Video Pattern Generator" (26 znaków)
static const unsigned char product_string[] = {
    2 + 2 * 26, // 54
    0x03,
    'U', 0, 'S', 0, 'B', 0, ' ', 0, 'V', 0, 'i', 0, 'd', 0, 'e', 0, 'o', 0, ' ', 0,
    'P', 0, 'a', 0, 't', 0, 't', 0, 'e', 0, 'r', 0, 'n', 0, ' ', 0, 'G', 0, 'e', 0, 'n', 0, 'e', 0, 'r', 0, 'a', 0, 't', 0, 'o', 0, 'r', 0};
